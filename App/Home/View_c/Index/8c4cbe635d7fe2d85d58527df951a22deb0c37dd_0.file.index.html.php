...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  array (
    ...
    function content_59268a2ff0e103_64128583(Smarty_Internal_Template $_smarty_tpl)
    {
?>
        <!DOCTYPE html>
...
assets/img/1.jpg" class="img-responsive img-rounded"/>
                    </a>
                    <div class="blog-info">
                    ...
                    <div class="blog-txt">
                        ...
                        Praesent efficitur quam aliquam mauris sagittis, vel lacinia risus luctus. Ut vitae bibendum
                        ipsum.
                    </div>
                </div>
                <!--BLOG ONE END -->
                <div class="blog-main">
                    ...
                    <a href="singlepost.html">
                        <img src="<?php echo INDEX_URL; ?>
assets/img/2.jpg" class="img-responsive img-rounded"/>
                    </a>
                    <div class="blog-info">
                        <span class="label label-primary">Posted on 26th November 2014</span>
                        <span class="label label-success">In Technology</span>
...
singlepost.html">
                        <img src="<?php echo INDEX_URL; ?>
assets/img/3.jpg" class="img-responsive img-rounded"/>
                    </a>
                    <div class="blog-info">
                        <span class="label label-primary">Posted on 26th November 2014</span>
                        <span class="label label-success">In Technology</span>
